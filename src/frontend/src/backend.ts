...
export class Backend implements backendInterface {
    ...
    async clearDetections(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearDetections();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getDetections(): Promise<Array<Detection>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDetections();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveDetection(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveDetection(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
